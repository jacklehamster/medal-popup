...
o.io.core = function(t, e) {
  ...
  }), this.addEventListener("App.checkSession", function(f) {
    if (f.success) {
...
class H {
  ...
  constructor(t = X) {
    this.#e = new o.io.core(t.key, t.skey), this.#l = t.debug, this.initSession(), this.audio = new Audio(t.audioIn ?? "https://jacklehamster.github.io/medal-popup/example/sounds/ng-sound.ogg"), this.audioOut = new Audio(t.audioOut ?? "https://jacklehamster.github.io/medal-popup/example/sounds/ng-sound-out.ogg"), this.gameUrl = t.url;
  }
  get loggedIn() {
    return !!this.#e.user;
  }
