...
o.io.model = { checkStrictValue: function(r, e, n, t, s, a, c) {
  if (t == "mixed")
    return true;
  if (n === null || typeof n == "undefined")
    return true;
  if (t && n.constructor === t)
    return true;
  if (t == Boolean && n.constructor === Number)
    return true;
  if (s && n.constructor === o.io.model[s])
    return true;
  if (n.constructor === Array && (a || c)) {
    for (var h = 0;h < n.length; h++)
      this.checkStrictValue(r, e, n[h], a, c, null, null);
    return true;
  }
  if (r)
    throw new Error("Illegal \'" + e + "\' value set in model " + r);
  return false;
} };
o.io.events.OutputEvent = function(r, e, n) {
  this.type = r, this.call = e, this.data = n, this.success = n && typeof (n.success != "undefined") ? n.success ? true : false : false, this.preventDefault = false;
};
o.io.events.OutputEvent.prototype.constructor = o.io.events.OutputEvent;
o.io.events.SessionEvent = function(r) {
  this.type = r, this.user = null, this.passport_url = null;
};
...
o.io.events.EventDispatcher.prototype = { _event_listeners: {}, addEventListener: function(r, e) {
  ...
  if (typeof this._event_listeners[r] == "undefined")
    this._event_listeners[r] = [];
  this._event_listeners[r].push(e);
}, removeEventListener: function(r, e) {
  if (typeof this._event_listeners[r] == "undefined")
    return;
  var n = -1;
  for (i = 0;i < this._event_listeners[r].length; i++)
    if (this._event_listeners[r][i] === e) {
      n = i;
      break;
    }
  if (n >= 0)
    return this._event_listeners[r].splice(n, 1), true;
  return false;
}, removeAllEventListeners: function(r) {
  if (typeof this._event_listeners[r] == "undefined")
    return 0;
  var e = this._event_listeners[r].length;
  return this._event_listeners[r] = [], e;
}, dispatchEvent: function(r) {
  var e = false, n;
  for (var t in o.io.events)
    if (r.constructor === o.io.events[t]) {
      e = true;
      break;
    }
  if (!e)
    throw new Error("Unsupported event object");
  if (typeof this._event_listeners[r.type] == "undefined")
    return false;
  for (var s = 0;s < this._event_listeners[r.type].length; s++)
    if (n = this._event_listeners[r.type][s], n(r) === false || r.preventDefault)
      return true;
  return true;
} };
o.io.events.EventDispatcher.prototype.constructor = o.io.events.EventDispatcher;
o.io.core = function(r, e) {
  var n, t, s, a, c = this, h, x = new o.io.urlHelper;
  if (x.getRequestQueryParam("ngio_session_id"))
    t = x.getRequestQueryParam("ngio_session_id");
...
o.io.core.prototype = { _session_loader: null, _call_queue: [], _event_listeners: {}, addEventListener: o.io.events.EventDispatcher.prototype.addEventListener, removeEventListener: o.io.events.EventDispatcher.prototype.removeEventListener, removeAllEventListeners: o.io.events.EventDispatcher.prototype.removeAllEventListeners, dispatchEvent: o.io.events.EventDispatcher.prototype.dispatchEvent, getSessionLoader: function() {
  ...
  var r = this.getSessionLoader();
  if (r.session)
    return r.session.user;
  return null;
}, getLoginError: function() {
  return this.getSessionLoader().last_error;
}, getValidSession: function(r, e) {
  this.getSessionLoader().getValidSession(r, e);
}, requestLogin: function(r, e, n, t) {
  ...
  function x() {
    n && n.constructor === Function ? n.call(t) : e.call(t), h();
  }
  ...
  this.getSessionLoader().endSession(r, e);
}, queueComponent: function(r, e, n, t) {
  if (e && e.constructor === Function && !n)
    n = e, e = null;
  var s = new o.io.model.call(this);
  if (s.component = r, typeof e != "undefined")
    s.parameters = e;
  this._validateCall(s), this._call_queue.push([s, n, t]);
}, executeQueue: function() {
  var r = [], e = [], n = [];
  for (var t = 0;t < this._call_queue.length; t++)
    r.push(this._call_queue[t][0]), e.push(this._call_queue[t][1]), n.push(this._call_queue[t][2]);
  this._doCall(r, e, n), this._call_queue = [];
}, callComponent: function(r, e, n, t) {
  if (e.constructor === Function && !n)
    n = e, e = null;
  var s = new o.io.model.call(this);
  if (s.component = r, typeof e != "undefined")
    s.parameters = e;
  this._validateCall(s), this._doCall(s, n, t);
}, _doCallback: function(r, e, n, t) {
  var s, a, c, h, x, d = { success: false, error: { code: 0, message: "Unexpected Server Response" } };
  if (typeof n == "undefined")
    n = null;
  if (r.constructor === Array && e && e.constructor === Array) {
    for (s = 0;s < r.length; s++)
      a = !n || typeof n[s] == "undefined" ? d : n[s], c = typeof e[s] == "undefined" ? null : e[s], this._doCallback(r[s], c, a, t[s]);
    return;
  }
  ...
  if (n)
    if (typeof n.data != "undefined")
      ...
      console.warn("Received empty data from \'" + r.component + "\'."), g = null;
  else
    g = d;
  var w;
  if (g.constructor === Array)
    for (s = 0;s < g.length; s++)
      w = new o.io.events.OutputEvent(r.component, r[s], g[s]), this.dispatchEvent(w);
  else
    w = new o.io.events.OutputEvent(r.component, r, g), this.dispatchEvent(w);
  if (e && e.constructor === Function)
    e.call(t, g);
}, _formatResults: function(r, e) {
  var n, t, s, a, c, h = null;
  if (typeof e.success != "undefined" && e.success)
    h = o.io.call_validators.getValidator(r);
  if (!h)
    return e;
  var x = h.returns;
  for (t in x) {
    if (typeof e[t] == "undefined" && e.success !== false) {
      console.warn("Newgrounds.io server failed to return expected \'" + t + "\' in \'" + r + "\' data.");
      continue;
    }
    if (typeof x[t].array != "undefined") {
      if (typeof x[t].array.object != "undefined")
        c = x[t].array.object;
      else
        c = x[t].array;
      if (typeof o.io.model[c] == "undefined") {
        console.warn("Received unsupported model \'" + c + "\' from \'" + r + "\'.");
        continue;
      }
      if (e[t].constructor !== Array) {
        console.warn("Expected array<" + c + "> value for \'" + t + "\' in \'" + r + "\' data, got " + typeof e[t]);
        continue;
      }
      a = [];
      for (s = 0;s < e[t].length; s++)
        n = new o.io.model[c](this), n.fromObject(e[t][s]), a.push(n);
      e[t] = a;
    } else if (typeof x[t].object != "undefined" && e[t]) {
      if (c = x[t].object, typeof o.io.model[c] == "undefined") {
        console.warn("Received unsupported model \'" + c + "\' from \'" + r + "\'.");
        continue;
      }
      n = new o.io.model[c](this), n.fromObject(e[t]), e[t] = n;
    }
  }
  return e;
}, _doCall: function(r, e, n) {
  if (!this.app_id)
    throw new Error("Attempted to call Newgrounds.io server without setting an app_id in Newgrounds.io.core instance.");
  var t, s = false, a = this;
  function c(_) {
  ...
  if (r.constructor === Array) {
    ...
    t = r.toObject(), s = c(r);
  var h = { app_id: this.app_id, session_id: this.session_id, call: t };
  if (this.debug)
    h.debug = 1;
  if (s) {
    var x = { success: true, app_id: this.app_id, result: { component: r.component, data: { success: true } } }, d = document.createElement("form");
...
}, _doValidateCall: function(r, e) {
  var n, t, s, a, c = o.io.call_validators.getValidator(r);
  if (!c)
    throw new Error("\'" + r + "\' is not a valid server component.");
  if (c.require_session && !this.session_id)
    throw new Error("\'" + r + "\' requires a session id");
  if (c.import && c.import.length > 0)
    for (n = 0;n < c.import.length; n++)
      t = c.import[n].split("."), this._doValidateCall(t[0], t[1], e);
  var h;
  for (s in c.params) {
    ...
    if (h === null) {
      if (a.required)
        throw new Error("Missing required parameter for \'" + r + "\': " + s);
      continue;
    }
    ...
    if (!o.io.model.checkStrictValue(null, s, h, a.type, null, null, null))
      throw new Error("Illegal value for \'" + s + "\' parameter of \'" + r + "\': " + h);
  }
}, _validateCall: function(r) {
  var e;
  if (r.constructor === Array) {
    var n = [];
    for (e = 0;e < r.length; e++)
      n.push(this._validateCall(r[e]));
    return n;
  } else if (r.constructor !== o.io.model.call)
    throw new Error("Unexpected \'call_model\' value. Expected Newgrounds.io.model.call instance.");
  var { component: t, parameters: s, echo: a } = r;
  if (s && s.constructor === Array)
    for (e = 0;e < s.length; e++)
      this._doValidateCall(t, s[e]);
  else
    this._doValidateCall(t, s);
  var c = { component: r.component }, h = o.io.call_validators.getValidator(r.component);
  if (typeof s != "undefined")
    if (h.secure) {
      var x = this._encryptCall(r);
      c.secure = x.secure;
    } else
      c.parameters = s;
...
o.io.urlHelper = function() {
  var r = window.location.href, e = {}, n = r.split("?").pop();
  if (n) {
    var t = n.split("&"), s;
    for (var a = 0;a < t.length; a++)
      s = t[a].split("="), e[s[0]] = s[1];
  }
...
o.io.model.call = function(r, e) {
  var n, t, s, a;
  this.__property_names = ["component", "echo", "parameters", "secure"], this.__classname = "Newgrounds.io.model.call", this.__ngio = r;
  var n;
...
o.io.model.call.prototype.toObject = function() {
  ...
  for (var e = 0;e < this.__property_names.length; e++)
    if (typeof this[this.__property_names[e]] != "undefined")
      r[this.__property_names[e]] = this[this.__property_names[e]];
  return r;
};
o.io.model.call.prototype.fromObject = function(r) {
  var e, n;
  for (var t = 0;t < this.__property_names.length; t++)
    e = r[this.__property_names[t]], this[this.__property_names[t]] = e;
};
o.io.model.call.prototype.constructor = o.io.model.call;
o.io.model.debug = function(r, e) {
  var n, t;
  this.__property_names = ["exec_time", "input"], this.__classname = "Newgrounds.io.model.debug", this.__ngio = r;
  var n;
  ...
  if (Object.defineProperty(this, "input", { get: function() {
    ...
    o.io.model.checkStrictValue(this.__classname, "input", s, null, "input", null, null), t = s;
  } }), e)
    this.fromObject(e);
};
...
o.io.model.debug.prototype.fromObject = function(r) {
  var e, n;
  for (var t = 0;t < this.__property_names.length; t++) {
    if (e = r[this.__property_names[t]], this.__property_names[t] == "input" && e)
      e = new o.io.model.input(this.__ngio, e);
    this[this.__property_names[t]] = e;
  }
};
o.io.model.debug.prototype.constructor = o.io.model.debug;
o.io.model.error = function(r, e) {
  var n, t;
  this.__property_names = ["code", "message"], this.__classname = "Newgrounds.io.model.error", this.__ngio = r;
  var n;
  ...
  if (Object.defineProperty(this, "message", { get: function() {
    ...
    o.io.model.checkStrictValue(this.__classname, "message", s, String, null, null, null), t = s;
  } }), e)
    this.fromObject(e);
};
...
o.io.model.error.prototype.fromObject = function(r) {
  var e, n;
  for (var t = 0;t < this.__property_names.length; t++)
    e = r[this.__property_names[t]], this[this.__property_names[t]] = e;
};
o.io.model.error.get = function(r, e) {
  var n = new o.io.model.error;
  return n.message = r ? r : "Unknown Error", n.code = e ? e : 0, n;
};
...
o.io.model.input = function(r, e) {
  var n, t, s, a, c;
  this.__property_names = ["app_id", "call", "debug", "echo", "session_id"], this.__classname = "Newgrounds.io.model.input", this.__ngio = r;
  var n;
  ...
  Object.defineProperty(this, "call", { get: function() {
    ...
    o.io.model.checkStrictValue(this.__classname, "call", h, null, "call", null, "call"), t = h;
  } });
  var s;
...
o.io.model.input.prototype.fromObject = function(r) {
  var e, n;
  for (var t = 0;t < this.__property_names.length; t++) {
    if (e = r[this.__property_names[t]], this.__property_names[t] == "call" && e)
      e = new o.io.model.call(this.__ngio, e);
    this[this.__property_names[t]] = e;
  }
};
o.io.model.input.prototype.constructor = o.io.model.input;
o.io.model.medal = function(r, e) {
  var n, t, s, a, c, h, x, d;
  this.__property_names = ["description", "difficulty", "icon", "id", "name", "secret", "unlocked", "value"], this.__classname = "Newgrounds.io.model.medal", this.__ngio = r;
  var n;
  ...
  Object.defineProperty(this, "difficulty", { get: function() {
    ...
    o.io.model.checkStrictValue(this.__classname, "difficulty", E, Number, null, null, null), t = E;
  } });
  var s;
...
o.io.model.medal.prototype.fromObject = function(r) {
  var e, n;
  for (var t = 0;t < this.__property_names.length; t++)
    e = r[this.__property_names[t]], this[this.__property_names[t]] = e;
};
o.io.model.medal.prototype.unlock = function(r) {
  var e = this;
  if (this._has_ngio_user())
    ...
    var n = o.io.model.error.get("This function requires a valid user session.", o.io.model.error.LOGIN_REQUIRED), t = { success: false, error: n };
    r(t);
  }
};
o.io.model.medal.prototype.constructor = o.io.model.medal;
o.io.model.output = function(r, e) {
  var n, t, s, a, c, h, x, d;
  this.__property_names = ["api_version", "app_id", "debug", "echo", "error", "help_url", "result", "success"], this.__classname = "Newgrounds.io.model.output", this.__ngio = r;
  var n;
  ...
  Object.defineProperty(this, "app_id", { get: function() {
    ...
    o.io.model.checkStrictValue(this.__classname, "app_id", E, String, null, null, null), t = E;
  } });
  var s;
  Object.defineProperty(this, "debug", { get: function() {
    return typeof s == "undefined" ? null : s;
...
o.io.model.output.prototype.fromObject = function(r) {
  var e, n;
  for (var t = 0;t < this.__property_names.length; t++) {
    if (e = r[this.__property_names[t]], this.__property_names[t] == "debug" && e)
      e = new o.io.model.debug(this.__ngio, e);
    else if (this.__property_names[t] == "error" && e)
      e = new o.io.model.error(this.__ngio, e);
    else if (this.__property_names[t] == "result" && e)
      e = new o.io.model.result(this.__ngio, e);
    this[this.__property_names[t]] = e;
  }
};
o.io.model.output.prototype.constructor = o.io.model.output;
o.io.model.result = function(r, e) {
  var n, t, s;
  this.__property_names = ["component", "data", "echo"], this.__classname = "Newgrounds.io.model.result", this.__ngio = r;
  var n;
  Object.defineProperty(this, "component", { get: function() {
    return typeof n == "undefined" ? null : n;
  }, set: function(a) {
  ...
  Object.defineProperty(this, "data", { get: function() {
    ...
    o.io.model.checkStrictValue(this.__classname, "data", a, Object, null, Object, null), t = a;
  } });
  var s;
...
o.io.model.result.prototype.fromObject = function(r) {
  var e, n;
  for (var t = 0;t < this.__property_names.length; t++)
    e = r[this.__property_names[t]], this[this.__property_names[t]] = e;
};
o.io.model.result.prototype.constructor = o.io.model.result;
o.io.model.score = function(r, e) {
  var n, t, s, a;
  this.__property_names = ["formatted_value", "tag", "user", "value"], this.__classname = "Newgrounds.io.model.score", this.__ngio = r;
  var n;
  ...
  Object.defineProperty(this, "tag", { get: function() {
    ...
    o.io.model.checkStrictValue(this.__classname, "tag", c, String, null, null, null), t = c;
  } });
  var s;
  Object.defineProperty(this, "user", { get: function() {
    return typeof s == "undefined" ? null : s;
...
o.io.model.score.prototype.fromObject = function(r) {
  var e, n;
  for (var t = 0;t < this.__property_names.length; t++) {
    if (e = r[this.__property_names[t]], this.__property_names[t] == "user" && e)
      e = new o.io.model.user(this.__ngio, e);
    this[this.__property_names[t]] = e;
  }
};
o.io.model.score.prototype.constructor = o.io.model.score;
o.io.model.scoreboard = function(r, e) {
  var n, t;
  this.__property_names = ["id", "name"], this.__classname = "Newgrounds.io.model.scoreboard", this.__ngio = r;
  var n;
  Object.defineProperty(this, "id", { get: function() {
    return typeof n == "undefined" ? null : n;
  }, set: function(s) {
  ...
  if (Object.defineProperty(this, "name", { get: function() {
    ...
    o.io.model.checkStrictValue(this.__classname, "name", s, String, null, null, null), t = s;
  } }), e)
    this.fromObject(e);
};
...
o.io.model.scoreboard.prototype.fromObject = function(r) {
  var e, n;
  for (var t = 0;t < this.__property_names.length; t++)
    e = r[this.__property_names[t]], this[this.__property_names[t]] = e;
};
o.io.model.scoreboard.prototype.postScore = function(r, e, n) {
  var t = this;
  ...
  if (!e)
    e = null;
  if (this._has_ngio_user())
    this.__ngio.callComponent("ScoreBoard.postScore", { id: this.id, value: r, tag: e }, function(c) {
      n(c);
    });
...
o.io.model.session = function(r, e) {
  var n, t, s, a, c;
  this.__property_names = ["expired", "id", "passport_url", "remember", "user"], this.__classname = "Newgrounds.io.model.session", this.__ngio = r;
  var n;
  ...
  Object.defineProperty(this, "id", { get: function() {
    ...
    o.io.model.checkStrictValue(this.__classname, "id", h, String, null, null, null), t = h;
  } });
  var s;
...
o.io.model.session.prototype.fromObject = function(r) {
  var e, n;
  for (var t = 0;t < this.__property_names.length; t++) {
    if (e = r[this.__property_names[t]], this.__property_names[t] == "user" && e)
      e = new o.io.model.user(this.__ngio, e);
...
o.io.model.user = function(r, e) {
  var n, t, s, a;
  this.__property_names = ["icons", "id", "name", "supporter"], this.__classname = "Newgrounds.io.model.user", this.__ngio = r;
  var n;
  ...
  Object.defineProperty(this, "id", { get: function() {
    ...
    o.io.model.checkStrictValue(this.__classname, "id", c, Number, null, null, null), t = c;
  } });
  var s;
  Object.defineProperty(this, "name", { get: function() {
    return typeof s == "undefined" ? null : s;
...
o.io.model.user.prototype.fromObject = function(r) {
  var e, n;
  for (var t = 0;t < this.__property_names.length; t++) {
    if (e = r[this.__property_names[t]], this.__property_names[t] == "icons" && e)
      e = new o.io.model.usericons(this.__ngio, e);
    this[this.__property_names[t]] = e;
  }
};
o.io.model.user.prototype.constructor = o.io.model.user;
o.io.model.usericons = function(r, e) {
  var n, t, s;
  this.__property_names = ["large", "medium", "small"], this.__classname = "Newgrounds.io.model.usericons", this.__ngio = r;
  var n;
  ...
  Object.defineProperty(this, "medium", { get: function() {
    ...
    o.io.model.checkStrictValue(this.__classname, "medium", a, String, null, null, null), t = a;
  } });
  var s;
...
o.io.model.usericons.prototype.fromObject = function(r) {
  var e, n;
  for (var t = 0;t < this.__property_names.length; t++)
    e = r[this.__property_names[t]], this[this.__property_names[t]] = e;
};
o.io.model.usericons.prototype.constructor = o.io.model.usericons;
o.io.call_validators.getValidator = function(r) {
  var e = r.split("."), n = e[0], t = e[1], s = o.io.call_validators[n] && o.io.call_validators[n][t] ? o.io.call_validators[n][t] : null;
  return s;
};
...
o.io.SessionLoader = function(r) {
  if (!r || r.constructor !== o.io.core)
...
o.io.SessionLoader.prototype = { _event_listeners: {}, last_error: null, passport_window: null, addEventListener: o.io.events.EventDispatcher.prototype.addEventListener, removeEventListener: o.io.events.EventDispatcher.prototype.removeEventListener, removeAllEventListeners: o.io.events.EventDispatcher.prototype.removeAllEventListeners, dispatchEvent: o.io.events.EventDispatcher.prototype.dispatchEvent, getValidSession: function(r, e) {
  var n = this;
  n.checkSession(function(t) {
    if (!t || t.expired)
      n.startSession(r, e);
    else
      r.call(e, t);
  });
}, startSession: function(r, e) {
  var n = new o.io.events.SessionEvent, t = this;
  this.__ngio.callComponent("App.startSession", function(s) {
    if (!s.success || !s.session) {
      if (s.error)
        t.last_error = s.error;
      else
        t.last_error = new o.io.model.error, t.last_error.message = "Unexpected Error";
      n.type = o.io.events.SessionEvent.SESSION_EXPIRED, t.session = null;
    } else
      n.type = o.io.events.SessionEvent.REQUEST_LOGIN, n.passport_url = s.session.passport_url, t.session = s.session;
    if (t.__ngio.session_id = t.session ? t.session.id : null, t.dispatchEvent(n), r && r.constructor === Function)
      r.call(e, t.session);
  });
}, checkSession: function(r, e) {
  var n = new o.io.events.SessionEvent, t = this;
  if (t.session && t.session.user) {
    if (n.type = o.io.events.SessionEvent.USER_LOADED, n.user = t.session.user, t.dispatchEvent(n), r && r.constructor === Function)
      r.call(e, t.session);
  } else if (!this.__ngio.session_id) {
    if (n.type = o.io.events.SessionEvent.SESSION_EXPIRED, t.session = null, t.dispatchEvent(n), r && r.constructor === Function)
      r.call(e, null);
  } else
    this.__ngio.callComponent("App.checkSession", function(s) {
      if (!s.success || !s.session || s.session.expired)
        if (n.type = o.io.events.SessionEvent.SESSION_EXPIRED, t.session = null, s.error)
          t.last_error = s.error;
        else if (t.last_error = new o.io.model.error, s.session && s.session.expired)
          t.last_error.message = "Session is Expired";
        else
          t.last_error.message = "Unexpected Error";
      else if (!s.session.user)
        n.type = o.io.events.SessionEvent.REQUEST_LOGIN, n.passport_url = s.session.passport_url, t.session = s.session;
      else
        n.type = o.io.events.SessionEvent.USER_LOADED, n.user = s.session.user, t.session = s.session;
      if (t.__ngio.session_id = t.session ? t.session.id : null, t.dispatchEvent(n), r && r.constructor === Function)
        r.call(e, t.session);
    });
}, endSession: function(r, e) {
  var n = this, t = this.__ngio;
  this.__ngio.callComponent("App.endSession", function(s) {
    n.session = null, t.session_id = null;
    var a = new o.io.events.SessionEvent(o.io.events.SessionEvent.SESSION_EXPIRED);
    if (n.dispatchEvent(a), r && r.constructor === Function)
      r.call(e, n.session);
  }), this.__ngio.session_id = null, this.session = null;
}, loadPassport: function(r) {
  if (typeof r != "string")
    r = "_blank";
  ...
  if (this.passport_window = window.open(this.session.passport_url, r), !this.passport_window)
...
var b = b || function(r, e) {
  var n = {}, t = n.lib = {}, s = function() {
  }, a = t.Base = { extend: function(l) {
    s.prototype = this;
    var f = new s;
  ...
  } }, c = t.WordArray = a.extend({ init: function(l, f) {
  ...
  } }, g = t.BufferedBlockAlgorithm = a.extend({ reset: function() {
    this._data = new c.init, this._nDataBytes = 0;
  }, _append: function(l) {
    typeof l == "string" && (l = E.parse(l)), this._data.concat(l), this._nDataBytes += l.sigBytes;
  }, _process: function(l) {
    var f = this._data, u = f.words, p = f.sigBytes, _ = this.blockSize, O = p / (4 * _), O = l ? r.ceil(O) : r.max((O | 0) - this._minBufferSize, 0);
    if (l = O * _, p = r.min(4 * l, p), l) {
      for (var A = 0;A < l; A += _)
  ...
  t.Hasher = g.extend({ cfg: a.extend(), init: function(l) {
...
(function() {
  var r = b, e = r.lib.WordArray;
  r.enc.Base64 = { stringify: function(n) {
    var { words: t, sigBytes: s } = n, a = this._map;
    n.clamp(), n = [];
    for (var c = 0;c < s; c += 3)
      for (var h = (t[c >>> 2] >>> 24 - 8 * (c % 4) & 255) << 16 | (t[c + 1 >>> 2] >>> 24 - 8 * ((c + 1) % 4) & 255) << 8 | t[c + 2 >>> 2] >>> 24 - 8 * ((c + 2) % 4) & 255, x = 0;4 > x && c + 0.75 * x < s; x++)
    ...
    var t = n.length, s = this._map, a = s.charAt(64);
    a && (a = n.indexOf(a), a != -1 && (t = a));
    for (var a = [], c = 0, h = 0;h < t; h++)
      if (h % 4) {
...
(function(r) {
  ...
  for (var a = b, x = a.lib, c = x.WordArray, h = x.Hasher, x = a.algo, d = [], E = 0;64 > E; E++)
    d[E] = 4294967296 * r.abs(r.sin(E + 1)) | 0;
  x = x.MD5 = h.extend({ _doReset: function() {
    ...
    var l = this._hash.words, f = g[w + 0], u = g[w + 1], p = g[w + 2], _ = g[w + 3], O = g[w + 4], A = g[w + 5], V = g[w + 6], U = g[w + 7], M = g[w + 8], I = g[w + 9], P = g[w + 10], j = g[w + 11], L = g[w + 12], B = g[w + 13], N = g[w + 14], C = g[w + 15], m = l[0], v = l[1], y = l[2], S = l[3], m = e(m, v, y, S, f, 7, d[0]), S = e(S, m, v, y, u, 12, d[1]), y = e(y, S, m, v, p, 17, d[2]), v = e(v, y, S, m, _, 22, d[3]), m = e(m, v, y, S, O, 7, d[4]), S = e(S, m, v, y, A, 12, d[5]), y = e(y, S, m, v, V, 17, d[6]), v = e(v, y, S, m, U, 22, d[7]), m = e(m, v, y, S, M, 7, d[8]), S = e(S, m, v, y, I, 12, d[9]), y = e(y, S, m, v, P, 17, d[10]), v = e(v, y, S, m, j, 22, d[11]), m = e(m, v, y, S, L, 7, d[12]), S = e(S, m, v, y, B, 12, d[13]), y = e(y, S, m, v, N, 17, d[14]), v = e(v, y, S, m, C, 22, d[15]), m = n(m, v, y, S, u, 5, d[16]), S = n(S, m, v, y, V, 9, d[17]), y = n(y, S, m, v, j, 14, d[18]), v = n(v, y, S, m, f, 20, d[19]), m = n(m, v, y, S, A, 5, d[20]), S = n(S, m, v, y, P, 9, d[21]), y = n(y, S, m, v, C, 14, d[22]), v = n(v, y, S, m, O, 20, d[23]), m = n(m, v, y, S, I, 5, d[24]), S = n(S, m, v, y, N, 9, d[25]), y = n(y, S, m, v, _, 14, d[26]), v = n(v, y, S, m, M, 20, d[27]), m = n(m, v, y, S, B, 5, d[28]), S = n(S, m, v, y, p, 9, d[29]), y = n(y, S, m, v, U, 14, d[30]), v = n(v, y, S, m, L, 20, d[31]), m = t(m, v, y, S, A, 4, d[32]), S = t(S, m, v, y, M, 11, d[33]), y = t(y, S, m, v, j, 16, d[34]), v = t(v, y, S, m, N, 23, d[35]), m = t(m, v, y, S, u, 4, d[36]), S = t(S, m, v, y, O, 11, d[37]), y = t(y, S, m, v, U, 16, d[38]), v = t(v, y, S, m, P, 23, d[39]), m = t(m, v, y, S, B, 4, d[40]), S = t(S, m, v, y, f, 11, d[41]), y = t(y, S, m, v, _, 16, d[42]), v = t(v, y, S, m, V, 23, d[43]), m = t(m, v, y, S, I, 4, d[44]), S = t(S, m, v, y, L, 11, d[45]), y = t(y, S, m, v, C, 16, d[46]), v = t(v, y, S, m, p, 23, d[47]), m = s(m, v, y, S, f, 6, d[48]), S = s(S, m, v, y, U, 10, d[49]), y = s(y, S, m, v, N, 15, d[50]), v = s(v, y, S, m, A, 21, d[51]), m = s(m, v, y, S, L, 6, d[52]), S = s(S, m, v, y, _, 10, d[53]), y = s(y, S, m, v, P, 15, d[54]), v = s(v, y, S, m, u, 21, d[55]), m = s(m, v, y, S, M, 6, d[56]), S = s(S, m, v, y, C, 10, d[57]), y = s(y, S, m, v, V, 15, d[58]), v = s(v, y, S, m, B, 21, d[59]), m = s(m, v, y, S, O, 6, d[60]), S = s(S, m, v, y, j, 10, d[61]), y = s(y, S, m, v, p, 15, d[62]), v = s(v, y, S, m, I, 21, d[63]);
    l[0] = l[0] + m | 0, l[1] = l[1] + v | 0, l[2] = l[2] + y | 0, l[3] = l[3] + S | 0;
  }, _doFinalize: function() {
    var g = this._data, w = g.words, l = 8 * this._nDataBytes, f = 8 * g.sigBytes;
    w[f >>> 5] |= 128 << 24 - f % 32;
    var u = r.floor(l / 4294967296);
...
(function() {
  var r = b, t = r.lib, e = t.Base, n = t.WordArray, t = r.algo, s = t.EvpKDF = e.extend({ cfg: e.extend({ keySize: 4, hasher: t.MD5, iterations: 1 }), init: function(a) {
  ...
  r.EvpKDF = function(a, c, h) {
    return s.create(h).compute(a, c);
  };
})();
b.lib.Cipher || function(r) {
  var l = b, e = l.lib, n = e.Base, t = e.WordArray, s = e.BufferedBlockAlgorithm, a = l.enc.Base64, c = l.algo.EvpKDF, h = e.Cipher = s.extend({ cfg: n.extend(), createEncryptor: function(u, p) {
  ...
  var g = l.mode = {}, x = function(u, p, _) {
    var O = this._iv;
    O ? this._iv = r : O = this._prevBlock;
    for (var A = 0;A < _; A++)
      u[p + A] ^= O[A];
  ...
  var E = e.CipherParams = n.extend({ init: function(u) {
    ...
    var p = u.ciphertext;
    return u = u.salt, (u ? t.create([1398893684, 1701076831]).concat(u).concat(p) : p).toString(a);
  }, parse: function(u) {
    u = a.parse(u);
    var p = u.words;
    if (p[0] == 1398893684 && p[1] == 1701076831) {
      var _ = t.create(p.slice(2, 4));
    ...
    return O || (O = t.random(8)), u = c.create({ keySize: p + _ }).compute(u, O), _ = t.create(u.words.slice(p), 4 * _), u.sigBytes = 4 * p, E.create({ key: u, iv: _, salt: O });
...
(function() {
  for (var r = b, e = r.lib.BlockCipher, M = r.algo, n = [], t = [], s = [], a = [], c = [], h = [], x = [], d = [], E = [], g = [], w = [], l = 0;256 > l; l++)
  ...
  var U = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54], M = M.AES = e.extend({ _doReset: function() {
    ...
    var j = I[P + 1];
    I[P + 1] = I[P + 3], I[P + 3] = j, this._doCryptBlock(I, P, this._invKeySchedule, x, d, E, g, t), j = I[P + 1], I[P + 1] = I[P + 3], I[P + 3] = j;
    ...
    for (var S = this._nRounds, q = I[P] ^ j[0], D = I[P + 1] ^ j[1], k = I[P + 2] ^ j[2], R = I[P + 3] ^ j[3], y = 4, v = 1;v < S; v++)
      var z = L[q >>> 24] ^ B[D >>> 16 & 255] ^ N[k >>> 8 & 255] ^ C[R & 255] ^ j[y++], T = L[D >>> 24] ^ B[k >>> 16 & 255] ^ N[R >>> 8 & 255] ^ C[q & 255] ^ j[y++], F = L[k >>> 24] ^ B[R >>> 16 & 255] ^ N[q >>> 8 & 255] ^ C[D & 255] ^ j[y++], R = L[R >>> 24] ^ B[q >>> 16 & 255] ^ N[D >>> 8 & 255] ^ C[k & 255] ^ j[y++], q = z, D = T, k = F;
    z = (m[q >>> 24] << 24 | m[D >>> 16 & 255] << 16 | m[k >>> 8 & 255] << 8 | m[R & 255]) ^ j[y++], T = (m[D >>> 24] << 24 | m[k >>> 16 & 255] << 16 | m[R >>> 8 & 255] << 8 | m[q & 255]) ^ j[y++], F = (m[k >>> 24] << 24 | m[R >>> 16 & 255] << 16 | m[q >>> 8 & 255] << 8 | m[D & 255]) ^ j[y++], R = (m[R >>> 24] << 24 | m[q >>> 16 & 255] << 16 | m[D >>> 8 & 255] << 8 | m[k & 255]) ^ j[y++], I[P] = z, I[P + 1] = T, I[P + 2] = F, I[P + 3] = R;
  }, keySize: 8 });
  r.AES = e._createHelper(M);
})();
...
class H {
  ...
  audioOut;
  gameUrl;
  static async validateSession(r, e = X) {
  ...
  validateSession(r) {
    return H.validateSession(r, this.#u);
  }
  addLoginListener(r) {
    this.#c.add(r);
  }
  ...
  constructor(r = X) {
    this.#u = r, this.#e = new o.io.core(r.key, r.skey), this.#a = r.debug, this.initSession(), this.audio = new Audio(r.audioIn ?? "https://jacklehamster.github.io/medal-popup/example/sounds/ng-sound.ogg"), this.audioOut = new Audio(r.audioOut ?? "https://jacklehamster.github.io/medal-popup/example/sounds/ng-sound-out.ogg"), this.gameUrl = r.url;
  }
  get loggedIn() {
    return !!this.#e.user;
  }
  ...
  async getScoreboards() {
    return new Promise((r) => {
      if (this.#n)
        ...
        this.#o = [r], this.#e.callComponent("ScoreBoard.getBoards", {}, (e) => {
          if (e.success) {
            this.#n = e.scoreboards;
            const n = {};
            this.#n.forEach((t) => n[t.id] = t.name), this.#o?.forEach((t) => t?.(this.#n ?? [])), this.#o = undefined;
          }
        });
    });
  }
  async getMedals() {
    return new Promise((r) => {
      if (this.#t)
        ...
        this.#r = [r], this.#e.callComponent("Medal.getList", {}, (e) => {
          if (e.success) {
            this.#t = e.medals;
            const n = "font-weight: bold;";
            console.log("%c Unlocked:", n, this.#t?.filter(({ unlocked: t }) => t).map(({ name: t }) => t).join(", ")), console.log("%c Locked:", n, this.#t?.filter(({ unlocked: t }) => !t).map(({ name: t }) => t).join(", ")), this.#r?.forEach((t) => t?.(this.#t ?? [])), this.#r = undefined;
          }
        });
    });
  }
  async unlockMedal(r) {
    if (!this.#e.user)
      return;
    console.log("unlocking", r, "for", this.#e.user.name);
    const e = await this.getMedals(), n = e.filter((t) => t.name === r)[0];
    if (n)
      return new Promise((t) => {
        if (!n.unlocked && !this.#l[n.id])
          this.#e.callComponent("Medal.unlock", { id: n.id }, (s) => {
            ...
            if (a) {
              for (let c = 0;c < e.length; c++)
                if (e[c].id === a.id)
                  e[c] = a;
              this.#l[a.id] = true, this.#p.forEach((c) => c(a)), this.showReceivedMedal(a), t(s.medal);
            }
          });
        else
          t(n);
      ...
      console.warn(`Medal doesn't exist: ${r}`);
  }
  requestLogin() {
    this.#e.requestLogin(this.onLoggedIn, this.onLoginFailed, this.onLoginCancelled);
    const r = document.getElementById("newgrounds-login");
    if (r)
  ...
  initSession() {
    this.#e.getValidSession((r) => {
      const e = !this.#a ? undefined : document.body.appendChild(document.createElement("button"));
      if (e)
        e.id = "newgrounds-login", e.style.position = "absolute", e.style.top = "5px", e.style.right = "5px", e.style.height = "24px", e.style.fontSize = "10pt", e.style.zIndex = "1000", e.classList.add("button"), e.innerText = "login newgrounds", e.addEventListener("click", (n) => {
          this.requestLogin(), n.stopPropagation();
        });
      if (this.#e.user)
        e?.parentElement?.removeChild(e), this.onLoggedIn();
    });
  }
  onLoggedIn() {
    console.log("Welcome ", this.#e.user?.name + "!"), this.#c.forEach((r) => r()), this.getMedals(), this.getScoreboards();
  }
  #s;
  #f() {
    if (!this.#s) {
      const r = document.body.appendChild(document.createElement("div"));
      r.style.display = "none", r.style.position = "absolute", r.style.right = "10px", r.style.top = "10px", r.style.padding = "5px 10px", r.style.border = "2px solid #880", r.style.borderRadius = "5px", r.style.background = "linear-gradient(#884, #553)", r.style.boxShadow = "2px 2px black", r.style.flexDirection = "row", r.style.transition = "opacity .5s, margin-right .3s", r.style.opacity = "0", r.style.marginRight = "-300px", r.style.zIndex = "3000", r.style.fontFamily = "Papyrus, fantasy", this.#s = r;
    }
    return this.#s;
  }
  #i;
  showReceivedMedal(r) {
    ...
    }), n.style.width = "50px", n.style.height = "50px", n.style.backgroundColor = "black", n.style.borderRadius = "3px", n.src = r.icon;
    const t = e.appendChild(document.createElement("div"));
    t.style.marginLeft = "10px";
    const s = t.appendChild(document.createElement("div"));
    s.style.fontWeight = "bold", s.style.fontSize = "12pt", s.style.color = "gold", s.style.margin = "5px", s.innerText = `\uD83C\uDFC6 ${r.name}`;
    const a = t.appendChild(document.createElement("div"));
    a.style.fontSize = "10pt", a.style.color = "silver", a.innerText = r.description;
  }
  async postScore(r, e) {
    const n = await this.getScoreboards(), t = e ? n.find((s) => s.name === e) : n[0];
    if (t)
      return new Promise((s) => {
        this.#e.callComponent("ScoreBoard.postScore", { id: t.id, value: r }, (a) => {
          s(a.success);
        });
      });
  }
  async logView() {
    this.#e.callComponent("App.logView", { host: location.host }, (r) => {
      console.log(r);
    });
  }
  async logEvent(r) {
    this.#e.callComponent("Event.logEvent", { event_name: r, host: location.host }, (e) => {
      console.log(e);
    });
  }
}
